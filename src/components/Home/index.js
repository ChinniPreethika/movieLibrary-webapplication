...
class Home extends Component {
  ...
  handleSearchFormSubmit = (event) => {
    ...
    const movieName = searchInput.trim() !== "" ? searchInput : "action";
  ...
  handleBackToACTION = () => {
    this.setState({ movieName: "action", searchInput: "" }, () => {
      this.fetchAllMovies("action");
    });
  };
      ...
      <div>
        ...
        <Sidebar>
              ...
              >
                ...
                <MenuItem component={<Link to="/playlist" />}>MovieList</MenuItem> {/* Add a link to the playlist page */}
              </Menu>
            </Sidebar>
